...
type
  ...
  public
    ...
    function SHA1_Sign_PK(msg : String):string;
     function SHA256_Sign_PK(msg : String):string;
   //   function SHA257_Sign_PK(msg : String):string;
    function SHA512_Sign_PK(msg : String):string;
...
function TRSAOpenSSL.SHA1_Sign_PK(msg : String):string;
var
     ctx : EVP_MD_CTX   ;  
     buf_in:Pchar;
     m_len,outl :cardinal;  
...
function TRSAOpenSSL.SHA512_Sign_PK(msg : String):string;
var
    ctx : EVP_MD_CTX   ;
    pKey :    PEVP_PKEY;   //Q4A38GwtqQ
   s1:string;
  midbuf_Len,outbuf_Len: cardinal;
  mdctx: EVP_MD_CTX;
  inbuf, midbuf,outbuf: array [0..10240] of char;
  key: pEVP_PKEY;
    i,count:Integer;
begin
  pKey := LoadPrivateKey(fPrivateKeyPath);
